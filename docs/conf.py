# -*- coding: utf-8 -*-
#
# SPAGHETTI documentation build configuration file, based on `giddy`. This file is
# execfile()d with the current directory set to its containing dir. Note that not all
# possible configuration values are present in this autogenerated file. All configuration
# values have a default; values that are commented out serve to show the default. If
# extensions (or modules to document with autodoc) are in another directory, add these
...
nbsphinx_prolog = r"""
{% set docname = env.doc2path(env.docname, base='notebooks/') %}
{% set fullpath = env.doc2path(env.docname, base='tree/main/notebooks/') %}
