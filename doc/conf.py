...
latex_documents = [
    (master_doc, 'spaghetti.tex', u'spaghetti Documentation',
...
man_pages = [
    (master_doc, 'spaghetti', u'spaghetti Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'spaghetti', u'spaghetti Documentation',
     author, 'spaghetti', 'SPAtial GrapHs: nETworks, Topology, & Inference',
     'Miscellaneous'),
]
